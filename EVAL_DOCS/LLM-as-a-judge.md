# LLM-as-a-Judge Evaluation with DeepEval (/guides/guides-llm-as-a-judge)
...
## What is LLM-as-a-Judge Evaluation? [#what-is-llm-as-a-judge-evaluation]
...
## Why Use LLM-as-a-Judge? [#why-use-llm-as-a-judge]
...
## Single-Output vs Pairwise LLM Judges [#single-output-vs-pairwise-llm-judges]
...
## Reference-Based vs Referenceless Judges [#reference-based-vs-referenceless-judges]
...
## The Three Main LLM Judge Techniques [#the-three-main-llm-judge-techniques]
...
### Technique 1: G-Eval for Custom LLM Judges [#technique-1-g-eval-for-custom-llm-judges]
...
#### Criteria vs Evaluation Steps [#criteria-vs-evaluation-steps]
...
#### Reference-Based vs Referenceless G-Eval [#reference-based-vs-referenceless-g-eval]
...
### Technique 2: DAG for More Deterministic LLM Judges [#technique-2-dag-for-more-deterministic-llm-judges]
...
### Technique 3: QAG for Built-In LLM Judge Metrics [#technique-3-qag-for-built-in-llm-judge-metrics]
...
## Choosing Between G-Eval, DAG, and QAG [#choosing-between-g-eval-dag-and-qag]
...
## Make LLM Judges More Reliable [#make-llm-judges-more-reliable]
...
## Validate LLM Judges with Human Annotations [#validate-llm-judges-with-human-annotations]
...
<ImageDisplayer src="/img/confident-human-annotation.png" alt="Human annotation workflow for cross-checking LLM judge scores" />
...
## Common LLM-as-a-Judge Workflows [#common-llm-as-a-judge-workflows]
...
### Regression Testing in CI/CD [#regression-testing-in-cicd]
...
### Trace and Component-Level Evaluation [#trace-and-component-level-evaluation]
...
<ImageDisplayer src="/img/confident-tracing-observability.png" alt="Confident AI tracing and observability workflow for evaluating LLM application components" />
...
## Debug Judge Scores [#debug-judge-scores]
