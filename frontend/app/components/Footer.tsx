...
export default function Footer() {
    ...
    return (
        <footer
            ref={ref}
            className={`mx-4 md:mx-10 mb-10 rounded-[2rem] bg-[#f0f0f0] relative overflow-hidden px-8 md:px-16 py-10 md:py-14 transition-all duration-700 ease-out font-dm ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
            style={{
