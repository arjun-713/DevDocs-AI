            ...
            <div className="max-w-[1800px] mx-auto w-full relative flex-1 flex flex-col justify-between">
                ...
                >
                    <style dangerouslySetInnerHTML={{
                        ...
                        @keyframes flow-dots-vertical { 0% { background-position: 0 0; } 100% { background-position: 0 -24px; } }
                        ...
                        .connector-line-v { background-image: radial-gradient(circle, #3b82f6 2px, transparent 2.5px); background-size: 10px 12px; background-position: center 0; background-repeat: repeat-y; width: 4px; border-radius: 4px; animation: flow-dots-vertical 1.5s linear infinite; opacity: 0.6; }
                    `}} />

                    {/* Diagram Container */}
                    <div className="w-full relative flex flex-wrap md:flex-nowrap items-center justify-center md:justify-between px-4 md:px-8 py-8 md:py-0 md:h-32 bg-white/60 rounded-3xl backdrop-blur-md border border-white/40 shadow-[0_12px_32px_-12px_rgba(0,0,0,0.08)] gap-y-10">

                        {/* 1. GitHub Repo Node */}
                        <div className="flex flex-col items-center gap-3 relative z-10 w-20 md:w-24">
                            <div className="w-[48px] h-[48px] md:w-[52px] md:h-[52px] bg-white rounded-full shadow-lg border border-gray-100 flex items-center justify-center shrink-0">
                                <svg width="20" height="20" md-width="22" md-height="22" viewBox="0 0 24 24" fill="currentColor" className="text-gray-800"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12z" /></svg>
                            </div>
                            <span className="text-[10px] font-medium text-gray-500 absolute -bottom-7 md:-bottom-8 whitespace-nowrap text-center">github.com/...</span>
                        </div>

                        {/* Connector 1 */}
                        <div className="flex-1 hidden md:block connector-line mx-2"></div>
                        <div className="md:hidden w-full h-8 flex justify-center -my-4">
                            <div className="connector-line-v h-full"></div>
                        </div>

                        {/* 2. Chunking Node */}
                        <div className="flex flex-col items-center gap-3 relative z-10 w-20 md:w-24">
                            <div className="w-[48px] h-[48px] md:w-[52px] md:h-[52px] bg-white rounded-full shadow-lg border border-gray-100 flex items-center justify-center shrink-0 relative overflow-hidden">
                            ...
                            <span className="text-[10px] font-medium text-gray-500 absolute -bottom-7 md:-bottom-8 whitespace-nowrap text-center">Chunked</span>
                        </div>

                        {/* Connector 2 */}
                        <div className="flex-1 hidden md:block connector-line mx-2" style={{ animationDelay: "-0.5s" }}></div>
                        <div className="md:hidden w-full h-8 flex justify-center -my-4">
                            <div className="connector-line-v h-full" style={{ animationDelay: "-0.5s" }}></div>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-3 relative z-10 w-20 md:w-24">
                            ...
                            <span className="text-[10px] font-medium text-gray-500 absolute -bottom-7 md:-bottom-8 whitespace-nowrap text-center">Indexed</span>
                        </div>

                        {/* Connector 3 */}
                        <div className="flex-1 hidden md:block connector-line mx-2" style={{ animationDelay: "-1s" }}></div>
                        <div className="md:hidden w-full h-8 flex justify-center -my-4">
                            <div className="connector-line-v h-full" style={{ animationDelay: "-1s" }}></div>
                        </div>

                        {/* 4. Search/Query Node */}
                        <div className="flex flex-col items-center gap-3 relative z-10 w-20 md:w-24">
                            <div className="w-[48px] h-[48px] md:w-[52px] md:h-[52px] bg-white rounded-full shadow-[0_0_15px_rgba(59,130,246,0.2)] border border-blue-100 flex items-center justify-center shrink-0 relative" style={{ animation: "pulse-glow 3s infinite" }}>
                            ...
                            <span className="text-[10px] font-medium text-gray-500 absolute -bottom-7 md:-bottom-8 whitespace-nowrap text-center">Queried</span>
                        </div>

                        {/* Connector 4 */}
                        <div className="flex-1 hidden md:block connector-line mx-2" style={{ animationDelay: "-1.5s" }}></div>
                        <div className="md:hidden w-full h-8 flex justify-center -my-4">
                            <div className="connector-line-v h-full" style={{ animationDelay: "-1.5s" }}></div>
                        </div>

                        {/* 5. Answer Node */}
                        <div className="flex flex-col items-center gap-3 relative z-10 w-20 md:w-24">
                            <div className="w-[48px] h-[48px] md:w-[52px] md:h-[52px] bg-white rounded-full shadow-lg border border-gray-100 flex items-center justify-center shrink-0 relative">
                            ...
                            <span className="text-[10px] font-medium text-gray-500 absolute -bottom-7 md:-bottom-8 whitespace-nowrap text-center">Answered</span>
                        </div>
